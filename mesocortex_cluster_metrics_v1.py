#!/usr/bin/env python3
"""
Mesocortex Cluster + Metrics v1

- Config-driven multi-node mesh + cortex + mesocortex
- Central MetricsModule that aggregates spikes and state
- Final summary printed at the end of the run

Layers:

  Message, BaseModule, NodeRuntime
  LoggerModule, EchoModule
  NetworkMeshModule (TCP mesh)
  Cortex7Core, Cortex7Module
  MesocortexModule (regions over nodes)
  MetricsModule (global telemetry)
"""
